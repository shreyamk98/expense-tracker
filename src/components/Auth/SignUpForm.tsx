...
import { TextInput, PasswordInput, Button, Stack, Checkbox, Text, Anchor, Alert, Progress, Group } from '@mantine/core';
		...
		<form onSubmit={handleSubmit}>
			<Stack gap="md">
				...
				<Checkbox
					label={
						<Text size="sm">
							I agree to the <Anchor size="sm">Terms and Conditions</Anchor> and{' '}
