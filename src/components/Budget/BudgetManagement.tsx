  ...
  return (
    <Stack gap="lg">
      ...
      <Group justify="space-between">
        <div>
          <Text size="xl" fw={600}>Budget Management</Text>
          <Text size="sm" c="dimmed">Set and track spending limits for different categories</Text>
        </div>
            ...
            <Card key={budget.id} p="md" withBorder>
              <Group justify="space-between" mb="md">
                <div>
                  ...
                  <Text size="sm" c="dimmed">{budget.period} budget</Text>
                </div>
                <Group gap="xs">
                  <ActionIcon 
                    variant="subtle" 
        ...
        <Card p="xl" withBorder>
          <Stack align="center" gap="md">
            ...
            <div style={{ textAlign: 'center' }}>
              <Text fw={500} mb="xs">No budgets set</Text>
